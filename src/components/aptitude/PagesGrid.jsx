      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between text-[10.5px] uppercase tracking-[0.32em] text-secondary">
            ...
            <span>{locked ? "Tap to settle" : "Hover to open"}</span>
          </div>
        </div>
        ...
        >
          <div>
            <div className="flex items-center justify-between mb-5">
              <span className="text-[10.5px] uppercase tracking-[0.36em] text-gold">{page.title}</span>
              <Icon className="w-4 h-4 text-gold" strokeWidth={1.25} />
            </div>
            <ul className="space-y-3">
              {page.tiers.map((t, i) => (
                <li key={i} className="border-l border-[rgba(200,169,126,0.45)] pl-3">
                  <div className="text-[10px] uppercase tracking-[0.32em] text-gold mb-1">{t.label}</div>
