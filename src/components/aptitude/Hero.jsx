...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Interactive lattice — screen blend so it reads as part of the
          video's own light rather than a plane sitting on top of it. */}
      <InteractiveGrid variant="hero" opacity={0.32} cellSize={56} />
