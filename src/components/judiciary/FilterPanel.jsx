  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed top-0 left-0 bottom-0 z-[70] w-full max-w-[420px] flex flex-col bg-[#0A0F1A] border-r border-[rgba(200,169,126,0.25)] shadow-2xl filter-panel-depth"
        style={{
